...
from PROGRAM.typing import VideoMemoryStrategy
...
def render() -> None:
	...
	VIDEO_MEMORY_STRATEGY_DROPDOWN = gradio.Dropdown(
		...
		choices = PROGRAM.choices.video_memory_strategies,
	...
	SYSTEM_MEMORY_LIMIT_SLIDER = gradio.Slider(
		...
		step = calc_int_step(PROGRAM.choices.system_memory_limit_range),
		minimum = PROGRAM.choices.system_memory_limit_range[0],
		maximum = PROGRAM.choices.system_memory_limit_range[-1],
