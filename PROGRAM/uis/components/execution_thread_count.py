...
def render() -> None:
	...
	EXECUTION_THREAD_COUNT_SLIDER = gradio.Slider(
		...
		step = calc_int_step(PROGRAM.choices.execution_thread_count_range),
		minimum = PROGRAM.choices.execution_thread_count_range[0],
		maximum = PROGRAM.choices.execution_thread_count_range[-1]
	)
