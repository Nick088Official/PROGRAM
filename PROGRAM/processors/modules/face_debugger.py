...
from PROGRAM import config, content_analyser, face_classifier, face_detector, face_landmarker, face_masker, face_recognizer, logger, process_manager, state_manager, wording
from PROGRAM.face_analyser import get_many_faces, get_one_face
from PROGRAM.face_helper import warp_face_by_face_landmark_5
...
from PROGRAM.filesystem import in_directory, same_file_extension
from PROGRAM.processors import choices as processors_choices
from PROGRAM.processors.typing import FaceDebuggerInputs
from PROGRAM.program_helper import find_argument_group
from PROGRAM.typing import ApplyStateItem, Args, Face, ProcessMode, QueuePayload, UpdateProgress, VisionFrame
...
def register_args(program : ArgumentParser) -> None:
	...
	if group_processors:
		...
		PROGRAM.jobs.job_store.register_step_keys([ 'face_debugger_items' ])
