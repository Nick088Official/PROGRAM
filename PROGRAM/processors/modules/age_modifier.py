...
from PROGRAM.face_helper import merge_matrix, paste_back, warp_face_by_face_landmark_5
...
from PROGRAM.processors.typing import AgeModifierInputs
from PROGRAM.program_helper import find_argument_group
from PROGRAM.thread_helper import thread_semaphore
from PROGRAM.typing import ApplyStateItem, Args, Face, InferencePool, Mask, ModelOptions, ModelSet, ProcessMode, QueuePayload, UpdateProgress, VisionFrame
...
MODEL_SET : ModelSet =\
{
	'styleganex_age':
	{
		'hashes':
		{
			'age_modifier':
			{
				'url': 'https://github.com/PROGRAM/PROGRAM-assets/releases/download/models-3.0.0/styleganex_age.hash',
		...
		'sources':
		{
			'age_modifier':
			{
				'url': 'https://github.com/PROGRAM/PROGRAM-assets/releases/download/models-3.0.0/styleganex_age.onnx',
...
def register_args(program : ArgumentParser) -> None:
	...
	if group_processors:
		...
		PROGRAM.jobs.job_store.register_step_keys([ 'age_modifier_model', 'age_modifier_direction' ])
