...
from PROGRAM.processors.typing import FrameColorizerInputs
...
from PROGRAM.vision import read_image, read_static_image, unpack_resolution, write_image
...
MODEL_SET : ModelSet =\
{
	'ddcolor':
	{
		'hashes':
		{
			'frame_colorizer':
			{
				'url': 'https://github.com/PROGRAM/PROGRAM-assets/releases/download/models-3.0.0/ddcolor.hash',
		...
		'sources':
		{
			'frame_colorizer':
			{
				'url': 'https://github.com/PROGRAM/PROGRAM-assets/releases/download/models-3.0.0/ddcolor.onnx',
	...
	'ddcolor_artistic':
	{
		'hashes':
		{
			'frame_colorizer':
			{
				'url': 'https://github.com/PROGRAM/PROGRAM-assets/releases/download/models-3.0.0/ddcolor_artistic.hash',
		...
		'sources':
		{
			'frame_colorizer':
			{
				'url': 'https://github.com/PROGRAM/PROGRAM-assets/releases/download/models-3.0.0/ddcolor_artistic.onnx',
	...
	'deoldify':
	{
		'hashes':
		{
			'frame_colorizer':
			{
				'url': 'https://github.com/PROGRAM/PROGRAM-assets/releases/download/models-3.0.0/deoldify.hash',
		...
		'sources':
		{
			'frame_colorizer':
			{
				'url': 'https://github.com/PROGRAM/PROGRAM-assets/releases/download/models-3.0.0/deoldify.onnx',
	...
	'deoldify_artistic':
	{
		'hashes':
		{
			'frame_colorizer':
			{
				'url': 'https://github.com/PROGRAM/PROGRAM-assets/releases/download/models-3.0.0/deoldify_artistic.hash',
		...
		'sources':
		{
			'frame_colorizer':
			{
				'url': 'https://github.com/PROGRAM/PROGRAM-assets/releases/download/models-3.0.0/deoldify_artistic.onnx',
	...
	'deoldify_stable':
	{
		'hashes':
		{
			'frame_colorizer':
			{
				'url': 'https://github.com/PROGRAM/PROGRAM-assets/releases/download/models-3.0.0/deoldify_stable.hash',
		...
		'sources':
		{
			'frame_colorizer':
			{
				'url': 'https://github.com/PROGRAM/PROGRAM-assets/releases/download/models-3.0.0/deoldify_stable.onnx',
...
def register_args(program : ArgumentParser) -> None:
	...
	if group_processors:
		...
		PROGRAM.jobs.job_store.register_step_keys([ 'frame_colorizer_model', 'frame_colorizer_blend', 'frame_colorizer_size' ])
