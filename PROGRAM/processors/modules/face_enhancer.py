...
from PROGRAM.face_analyser import get_many_faces, get_one_face
from PROGRAM.face_helper import paste_back, warp_face_by_face_landmark_5
from PROGRAM.face_masker import create_occlusion_mask, create_static_box_mask
...
from PROGRAM.processors.typing import FaceEnhancerInputs
from PROGRAM.program_helper import find_argument_group
from PROGRAM.thread_helper import thread_semaphore
...
from PROGRAM.vision import read_image, read_static_image, write_image
...
MODEL_SET : ModelSet =\
{
	'codeformer':
	{
		'hashes':
		{
			'face_enhancer':
			{
				'url': 'https://github.com/PROGRAM/PROGRAM-assets/releases/download/models-3.0.0/codeformer.hash',
		...
		'sources':
		{
			'face_enhancer':
			{
				'url': 'https://github.com/PROGRAM/PROGRAM-assets/releases/download/models-3.0.0/codeformer.onnx',
	...
	'gfpgan_1.2':
	{
		'hashes':
		{
			'face_enhancer':
			{
				'url': 'https://github.com/PROGRAM/PROGRAM-assets/releases/download/models-3.0.0/gfpgan_1.2.hash',
		...
		'sources':
		{
			'face_enhancer':
			{
				'url': 'https://github.com/PROGRAM/PROGRAM-assets/releases/download/models-3.0.0/gfpgan_1.2.onnx',
	...
	'gfpgan_1.3':
	{
		'hashes':
		{
			'face_enhancer':
			{
				'url': 'https://github.com/PROGRAM/PROGRAM-assets/releases/download/models-3.0.0/gfpgan_1.3.hash',
		...
		'sources':
		{
			'face_enhancer':
			{
				'url': 'https://github.com/PROGRAM/PROGRAM-assets/releases/download/models-3.0.0/gfpgan_1.3.onnx',
	...
	'gfpgan_1.4':
	{
		'hashes':
		{
			'face_enhancer':
			{
				'url': 'https://github.com/PROGRAM/PROGRAM-assets/releases/download/models-3.0.0/gfpgan_1.4.hash',
		...
		'sources':
		{
			'face_enhancer':
			{
				'url': 'https://github.com/PROGRAM/PROGRAM-assets/releases/download/models-3.0.0/gfpgan_1.4.onnx',
	...
	'gpen_bfr_256':
	{
		'hashes':
		{
			'face_enhancer':
			{
				'url': 'https://github.com/PROGRAM/PROGRAM-assets/releases/download/models-3.0.0/gpen_bfr_256.hash',
		...
		'sources':
		{
			'face_enhancer':
			{
				'url': 'https://github.com/PROGRAM/PROGRAM-assets/releases/download/models-3.0.0/gpen_bfr_256.onnx',
	...
	'gpen_bfr_512':
	{
		'hashes':
		{
			'face_enhancer':
			{
				'url': 'https://github.com/PROGRAM/PROGRAM-assets/releases/download/models-3.0.0/gpen_bfr_512.hash',
		...
		'sources':
		{
			'face_enhancer':
			{
				'url': 'https://github.com/PROGRAM/PROGRAM-assets/releases/download/models-3.0.0/gpen_bfr_512.onnx',
	...
	'gpen_bfr_1024':
	{
		'hashes':
		{
			'face_enhancer':
			{
				'url': 'https://github.com/PROGRAM/PROGRAM-assets/releases/download/models-3.0.0/gpen_bfr_1024.hash',
		...
		'sources':
		{
			'face_enhancer':
			{
				'url': 'https://github.com/PROGRAM/PROGRAM-assets/releases/download/models-3.0.0/gpen_bfr_1024.onnx',
	...
	'gpen_bfr_2048':
	{
		'hashes':
		{
			'face_enhancer':
			{
				'url': 'https://github.com/PROGRAM/PROGRAM-assets/releases/download/models-3.0.0/gpen_bfr_2048.hash',
		...
		'sources':
		{
			'face_enhancer':
			{
				'url': 'https://github.com/PROGRAM/PROGRAM-assets/releases/download/models-3.0.0/gpen_bfr_2048.onnx',
	...
	'restoreformer_plus_plus':
	{
		'hashes':
		{
			'face_enhancer':
			{
				'url': 'https://github.com/PROGRAM/PROGRAM-assets/releases/download/models-3.0.0/restoreformer_plus_plus.hash',
		...
		'sources':
		{
			'face_enhancer':
			{
				'url': 'https://github.com/PROGRAM/PROGRAM-assets/releases/download/models-3.0.0/restoreformer_plus_plus.onnx',
...
def register_args(program : ArgumentParser) -> None:
	...
	if group_processors:
		...
		PROGRAM.jobs.job_store.register_step_keys([ 'face_enhancer_model', 'face_enhancer_blend' ])
