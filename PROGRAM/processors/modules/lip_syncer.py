...
from PROGRAM import config, content_analyser, face_classifier, face_detector, face_landmarker, face_masker, face_recognizer, inference_manager, logger, process_manager, state_manager, voice_extractor, wording
from PROGRAM.audio import create_empty_audio_frame, get_voice_frame, read_static_voice
...
from PROGRAM.face_helper import create_bounding_box, paste_back, warp_face_by_bounding_box, warp_face_by_face_landmark_5
from PROGRAM.face_masker import create_mouth_mask, create_occlusion_mask, create_static_box_mask
...
from PROGRAM.filesystem import filter_audio_paths, has_audio, in_directory, is_image, is_video, resolve_relative_path, same_file_extension
from PROGRAM.processors import choices as processors_choices
from PROGRAM.processors.typing import LipSyncerInputs
from PROGRAM.program_helper import find_argument_group
from PROGRAM.thread_helper import conditional_thread_semaphore
from PROGRAM.typing import ApplyStateItem, Args, AudioFrame, Face, InferencePool, ModelOptions, ModelSet, ProcessMode, QueuePayload, UpdateProgress, VisionFrame
from PROGRAM.vision import read_image, read_static_image, restrict_video_fps, write_image
...
MODEL_SET : ModelSet =\
{
	'wav2lip':
	{
		'hashes':
		{
			'lip_syncer':
			{
				'url': 'https://github.com/PROGRAM/PROGRAM-assets/releases/download/models-3.0.0/wav2lip.hash',
		...
		'sources':
		{
			'lip_syncer':
			{
				'url': 'https://github.com/PROGRAM/PROGRAM-assets/releases/download/models-3.0.0/wav2lip.onnx',
	...
	'wav2lip_gan':
	{
		'hashes':
		{
			'lip_syncer':
			{
				'url': 'https://github.com/PROGRAM/PROGRAM-assets/releases/download/models-3.0.0/wav2lip_gan.hash',
		...
		'sources':
		{
			'lip_syncer':
			{
				'url': 'https://github.com/PROGRAM/PROGRAM-assets/releases/download/models-3.0.0/wav2lip_gan.onnx',
...
def register_args(program : ArgumentParser) -> None:
	...
	if group_processors:
		...
		PROGRAM.jobs.job_store.register_step_keys([ 'lip_syncer_model' ])
