...
import PROGRAM.jobs.job_manager
import PROGRAM.jobs.job_store
import PROGRAM.processors.core as processors
from PROGRAM import config, content_analyser, face_classifier, face_detector, face_landmarker, face_masker, face_recognizer, inference_manager, logger, process_manager, state_manager, wording
from PROGRAM.common_helper import get_first
from PROGRAM.download import conditional_download_hashes, conditional_download_sources
from PROGRAM.execution import has_execution_provider
from PROGRAM.face_analyser import get_average_face, get_many_faces, get_one_face
from PROGRAM.face_helper import paste_back, warp_face_by_face_landmark_5
from PROGRAM.face_masker import create_occlusion_mask, create_region_mask, create_static_box_mask
from PROGRAM.face_selector import find_similar_faces, sort_and_filter_faces
from PROGRAM.face_store import get_reference_faces
from PROGRAM.filesystem import filter_image_paths, has_image, in_directory, is_image, is_video, resolve_relative_path, same_file_extension
from PROGRAM.inference_manager import get_static_model_initializer
from PROGRAM.processors import choices as processors_choices
from PROGRAM.processors.pixel_boost import explode_pixel_boost, implode_pixel_boost
from PROGRAM.processors.typing import FaceSwapperInputs
from PROGRAM.program_helper import find_argument_group, suggest_face_swapper_pixel_boost_choices
from PROGRAM.thread_helper import conditional_thread_semaphore
from PROGRAM.typing import ApplyStateItem, Args, Embedding, Face, InferencePool, ModelOptions, ModelSet, ProcessMode, QueuePayload, UpdateProgress, VisionFrame
from PROGRAM.vision import read_image, read_static_image, read_static_images, unpack_resolution, write_image
...
MODEL_SET : ModelSet =\
{
	'blendswap_256':
	{
		'hashes':
		{
			'face_swapper':
			{
				'url': 'https://github.com/PROGRAM/PROGRAM-assets/releases/download/models-3.0.0/blendswap_256.hash',
		...
		'sources':
		{
			'face_swapper':
			{
				'url': 'https://github.com/PROGRAM/PROGRAM-assets/releases/download/models-3.0.0/blendswap_256.onnx',
	...
	'ghost_256_unet_1':
	{
		'hashes':
		{
			'face_swapper':
			{
				'url': 'https://github.com/PROGRAM/PROGRAM-assets/releases/download/models-3.0.0/ghost_256_unet_1.hash',
				'path': resolve_relative_path('../.assets/models/ghost_256_unet_1.hash')
			},
			'embedding_converter':
			{
				'url': 'https://github.com/PROGRAM/PROGRAM-assets/releases/download/models-3.0.0/arcface_converter_ghost.hash',
		...
		'sources':
		{
			'face_swapper':
			{
				'url': 'https://github.com/PROGRAM/PROGRAM-assets/releases/download/models-3.0.0/ghost_256_unet_1.onnx',
				'path': resolve_relative_path('../.assets/models/ghost_256_unet_1.onnx')
			},
			'embedding_converter':
			{
				'url': 'https://github.com/PROGRAM/PROGRAM-assets/releases/download/models-3.0.0/arcface_converter_ghost.onnx',
	...
	'ghost_256_unet_2':
	{
		'hashes':
		{
			'face_swapper':
			{
				'url': 'https://github.com/PROGRAM/PROGRAM-assets/releases/download/models-3.0.0/ghost_256_unet_2.hash',
		...
		'sources':
		{
			'face_swapper':
			{
				'url': 'https://github.com/PROGRAM/PROGRAM-assets/releases/download/models-3.0.0/ghost_256_unet_2.onnx',
	...
	'ghost_256_unet_3':
	{
		'hashes':
		{
			'face_swapper':
			{
				'url': 'https://github.com/PROGRAM/PROGRAM-assets/releases/download/models-3.0.0/ghost_256_unet_3.hash',
		...
		'sources':
		{
			'face_swapper':
			{
				'url': 'https://github.com/PROGRAM/PROGRAM-assets/releases/download/models-3.0.0/ghost_256_unet_3.onnx',
	...
	'inswapper_128':
	{
		'hashes':
		{
			'face_swapper':
			{
				'url': 'https://github.com/PROGRAM/PROGRAM-assets/releases/download/models-3.0.0/inswapper_128.hash',
		...
		'sources':
		{
			'face_swapper':
			{
				'url': 'https://github.com/PROGRAM/PROGRAM-assets/releases/download/models-3.0.0/inswapper_128.onnx',
	...
	'inswapper_128_fp16':
	{
		'hashes':
		{
			'face_swapper':
			{
				'url': 'https://github.com/PROGRAM/PROGRAM-assets/releases/download/models-3.0.0/inswapper_128_fp16.hash',
		...
		'sources':
		{
			'face_swapper':
			{
				'url': 'https://github.com/PROGRAM/PROGRAM-assets/releases/download/models-3.0.0/inswapper_128_fp16.onnx',
	...
	'simswap_256':
	{
		'hashes':
		{
			'face_swapper':
			{
				'url': 'https://github.com/PROGRAM/PROGRAM-assets/releases/download/models-3.0.0/simswap_256.hash',
				'path': resolve_relative_path('../.assets/models/simswap_256.hash')
			},
			'embedding_converter':
			{
				'url': 'https://github.com/PROGRAM/PROGRAM-assets/releases/download/models-3.0.0/arcface_converter_simswap.hash',
		...
		'sources':
		{
			'face_swapper':
			{
				'url': 'https://github.com/PROGRAM/PROGRAM-assets/releases/download/models-3.0.0/simswap_256.onnx',
				'path': resolve_relative_path('../.assets/models/simswap_256.onnx')
			},
			'embedding_converter':
			{
				'url': 'https://github.com/PROGRAM/PROGRAM-assets/releases/download/models-3.0.0/arcface_converter_simswap.onnx',
	...
	'simswap_512_unofficial':
	{
		'hashes':
		{
			'face_swapper':
			{
				'url': 'https://github.com/PROGRAM/PROGRAM-assets/releases/download/models-3.0.0/simswap_512_unofficial.hash',
		...
		'sources':
		{
			'face_swapper':
			{
				'url': 'https://github.com/PROGRAM/PROGRAM-assets/releases/download/models-3.0.0/simswap_512_unofficial.onnx',
	...
	'uniface_256':
	{
		'hashes':
		{
			'face_swapper':
			{
				'url': 'https://github.com/PROGRAM/PROGRAM-assets/releases/download/models-3.0.0/uniface_256.hash',
		...
		'sources':
		{
			'face_swapper':
			{
				'url': 'https://github.com/PROGRAM/PROGRAM-assets/releases/download/models-3.0.0/uniface_256.onnx',
...
def register_args(program : ArgumentParser) -> None:
	...
	if group_processors:
		...
		PROGRAM.jobs.job_store.register_step_keys([ 'face_swapper_model', 'face_swapper_pixel_boost' ])
