...
from PROGRAM.typing import Age, FaceLandmark5, Gender, InferencePool, ModelOptions, ModelSet, Race, VisionFrame
...
MODEL_SET : ModelSet =\
{
	'fairface':
	{
		'hashes':
		{
			'face_classifier':
			{
				'url': 'https://github.com/PROGRAM/PROGRAM-assets/releases/download/models-3.0.0/fairface.hash',
		...
		'sources':
		{
			'face_classifier':
			{
				'url': 'https://github.com/PROGRAM/PROGRAM-assets/releases/download/models-3.0.0/fairface.onnx',
