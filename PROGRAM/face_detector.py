...
from PROGRAM import inference_manager, state_manager
from PROGRAM.download import conditional_download_hashes, conditional_download_sources
from PROGRAM.face_helper import create_rotated_matrix_and_size, create_static_anchors, distance_to_bounding_box, distance_to_face_landmark_5, normalize_bounding_box, transform_bounding_box, transform_points
from PROGRAM.filesystem import resolve_relative_path
from PROGRAM.thread_helper import thread_semaphore
from PROGRAM.typing import Angle, BoundingBox, Detection, DownloadSet, FaceLandmark5, InferencePool, ModelSet, Score, VisionFrame
from PROGRAM.vision import resize_frame_resolution, unpack_resolution
...
MODEL_SET : ModelSet =\
{
	'retinaface':
	{
		'hashes':
		{
			'retinaface':
			{
				'url': 'https://github.com/PROGRAM/PROGRAM-assets/releases/download/models-3.0.0/retinaface_10g.hash',
		...
		'sources':
		{
			'retinaface':
			{
				'url': 'https://github.com/PROGRAM/PROGRAM-assets/releases/download/models-3.0.0/retinaface_10g.onnx',
	...
	'scrfd':
	{
		'hashes':
		{
			'scrfd':
			{
				'url': 'https://github.com/PROGRAM/PROGRAM-assets/releases/download/models-3.0.0/scrfd_2.5g.hash',
		...
		'sources':
		{
			'scrfd':
			{
				'url': 'https://github.com/PROGRAM/PROGRAM-assets/releases/download/models-3.0.0/scrfd_2.5g.onnx',
	...
	'yoloface':
	{
		'hashes':
		{
			'yoloface':
			{
				'url': 'https://github.com/PROGRAM/PROGRAM-assets/releases/download/models-3.0.0/yoloface_8n.hash',
		...
		'sources':
		{
			'yoloface':
			{
				'url': 'https://github.com/PROGRAM/PROGRAM-assets/releases/download/models-3.0.0/yoloface_8n.onnx',
