...
from PROGRAM.face_helper import create_rotated_matrix_and_size, estimate_matrix_by_face_landmark_5, transform_points, warp_face_by_translation
from PROGRAM.filesystem import resolve_relative_path
from PROGRAM.thread_helper import conditional_thread_semaphore
from PROGRAM.typing import Angle, BoundingBox, DownloadSet, FaceLandmark5, FaceLandmark68, InferencePool, ModelSet, Prediction, Score, VisionFrame
...
MODEL_SET : ModelSet =\
{
	'2dfan4':
	{
		'hashes':
		{
			'2dfan4':
			{
				'url': 'https://github.com/PROGRAM/PROGRAM-assets/releases/download/models-3.0.0/2dfan4.hash',
		...
		'sources':
		{
			'2dfan4':
			{
				'url': 'https://github.com/PROGRAM/PROGRAM-assets/releases/download/models-3.0.0/2dfan4.onnx',
	...
	'peppa_wutz':
	{
		'hashes':
		{
			'peppa_wutz':
			{
				'url': 'https://github.com/PROGRAM/PROGRAM-assets/releases/download/models-3.0.0/peppa_wutz.hash',
		...
		'sources':
		{
			'peppa_wutz':
			{
				'url': 'https://github.com/PROGRAM/PROGRAM-assets/releases/download/models-3.0.0/peppa_wutz.onnx',
	...
	'fan_68_5':
	{
		'hashes':
		{
			'fan_68_5':
			{
				'url': 'https://github.com/PROGRAM/PROGRAM-assets/releases/download/models-3.0.0/fan_68_5.hash',
		...
		'sources':
		{
			'fan_68_5':
			{
				'url': 'https://github.com/PROGRAM/PROGRAM-assets/releases/download/models-3.0.0/fan_68_5.onnx',
