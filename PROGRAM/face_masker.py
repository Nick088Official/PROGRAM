...
from PROGRAM import inference_manager
...
from PROGRAM.typing import DownloadSet, FaceLandmark68, FaceMaskRegion, InferencePool, Mask, ModelSet, Padding, VisionFrame
...
MODEL_SET : ModelSet =\
{
	'face_occluder':
	{
		'hashes':
		{
			'face_occluder':
			{
				'url': 'https://github.com/PROGRAM/PROGRAM-assets/releases/download/models-3.0.0/dfl_xseg.hash',
		...
		'sources':
		{
			'face_occluder':
			{
				'url': 'https://github.com/PROGRAM/PROGRAM-assets/releases/download/models-3.0.0/dfl_xseg.onnx',
	...
	'face_parser':
	{
		'hashes':
		{
			'face_parser':
			{
				'url': 'https://github.com/PROGRAM/PROGRAM-assets/releases/download/models-3.0.0/resnet_34.hash',
		...
		'sources':
		{
			'face_parser':
			{
				'url': 'https://github.com/PROGRAM/PROGRAM-assets/releases/download/models-3.0.0/resnet_34.onnx',
